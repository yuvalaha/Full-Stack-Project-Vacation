...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2024 at 08:38 AM
...
--
-- Table structure for table `new_vacations`
--
...
--
-- Dumping data for table `new_vacations`
--

INSERT INTO `new_vacations` (`vacation_id`, `country_id`, `description`, `vacation_start_date`, `vacation_end_date`, `price`, `vacation_image`) VALUES
...
--
-- Indexes for table `new_vacations`
--
ALTER TABLE `new_vacations`
...
--
-- AUTO_INCREMENT for table `new_vacations`
--
ALTER TABLE `new_vacations`
...
ALTER TABLE `likes`
  ...
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`vacation_id`) REFERENCES `new_vacations` (`vacation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `new_vacations`
--
ALTER TABLE `new_vacations`
  ADD CONSTRAINT `new_vacations_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`);
